...
// Chords Guide Toggle
const chordsGuideToggle = document.getElementById('chords-guide-toggle');
const chordsGuideOverlay = document.getElementById('chords-guide');
const chordsGuideClose = document.getElementById('chords-guide-close');
...
if (chordsGuideToggle && chordsGuideOverlay && chordsGuideClose) {
    chordsGuideToggle.addEventListener('click', () => {
        chordsGuideOverlay.classList.add('active');
    });

    chordsGuideClose.addEventListener('click', () => {
        chordsGuideOverlay.classList.remove('active');
    });

    chordsGuideOverlay.addEventListener('click', (e) => {
        if (e.target === chordsGuideOverlay) {
            chordsGuideOverlay.classList.remove('active');
        }
    });
}
...
window.addEventListener('keydown', (e) => {
    if (e.key === 'Escape') {
        ...
        if (chordsGuideOverlay && chordsGuideOverlay.classList.contains('active')) {
            chordsGuideOverlay.classList.remove('active');
        }
    }
});
